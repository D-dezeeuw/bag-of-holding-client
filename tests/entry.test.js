  ...
  it('exposes every advertised subsystem', () => {
    const perSubsystem = {
      ...
      lore: ['mintLore', 'mintEras', 'mintCrownStub', 'CROWN_SCHEMA', 'LEGEND_SCHEMA',
        'mintFactionStubs', 'mintWarState', 'bindCrownsToFactions', 'WAR_CAUSES',
        'mintNpcStubs', 'NPC_VOICES', 'NPC_WANTS', 'WORLD_NPC_SCHEMA'],
      ...
      revision: ['cellsOf', 'entityIdsOf', 'projectCells',
        'REVISION_VERSION', 'REVISION_CELLS', 'makeRevision', 'mountRevision',
        'applyRevision', 'applyRevisions', 'resolvedDigest', 'classifyRevision', 'revisionConflicts'],
      ...
      crossings: ['portAnchorOf', 'mintLandfall', 'whileYouWereGone', 'MENACE_TIERS', 'menaceHints', 'MENACE_SIGNPOSTS'],
